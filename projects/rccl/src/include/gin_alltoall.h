...
// The devComm is private to this path so it does not disturb the symmetric
// kernels' own devComm.
//
// Declared unconditionally on purpose: ncclComm embeds this, and rcclras is
// built without ENABLE_ROCSHMEM_GIN, so gating it would make the two disagree
// on the layout of ncclComm.
